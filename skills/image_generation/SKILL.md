...
description: 文本生成图像工具。支持多分辨率（1K/2K/4K）、多种长宽比例（1:1, 3:2, 2:3, 16:9, 9:16）以及透明/不透明背景控制，生成图像并本地保存展示。
category: 视听创作
tags: [AI生图, 图像生成, 提示词绘图, SD, Midjourney, DALL-E]
aliases: [ai-image-gen, 生图工具]
---
# Image Generation
