...
def main():
    ...
    md2pdf_p.add_argument("--references-heading", default="References",
                          help="Heading for the references section (e.g. References)")
