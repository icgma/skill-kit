...
def _parse_pages(pages_str: str, total: int) -> list:
    ...
    Pages are 1-based; ranges are inclusive and clamped to the document.
    Malformed input follows the CLI contract: JSON error on stderr, exit 1
    (argument error) — never a raw traceback.
    """
    if not pages_str:
    ...
    for part in pages_str.split(","):
        ...
        try:
            ...
            Output.error(
                ...
                hint="Use 1-based pages like '1-3', '1,3,5' or '1-3,5,7-9'",
            )
