...
story.append(Image('chart.png', width=14*cm, height=8.4*cm))
```
...
ax.axis('off')
fig.savefig('formula.png', dpi=150, bbox_inches='tight', transparent=True)
plt.close()

story.append(Image('formula.png', width=8*cm, height=1.5*cm))
```
...
story.append(Image('flowchart.png', width=10*cm))
