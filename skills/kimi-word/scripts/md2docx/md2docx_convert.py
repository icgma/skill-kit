...
from docx_utils import normalize_omml
...
def convert_md_to_docx(
    ...
    # ── 5.5 Normalize pandoc OMML quirks (schema-invalid math) ──
    omml_fixed = normalize_omml(str(base_docx_path))
    if omml_fixed:
        logger.info(f"Normalized {omml_fixed} OMML propertie(s) from pandoc output")
