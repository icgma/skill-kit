...
| `get_fund_info` | 基金档案、费率、经理、风格、业绩基准 | `"华夏成长混合(000001.OF)基金档案"` |
| `get_fund_financials` | 利润、净值、收入、费用、分红 | `"000001.OF2024年净利润和分红"` |
| `get_fund_holdings` | 重仓股、资产配置、行业配置 | `"000001.OF最新一期重仓股"` |
| `get_fund_performance` | 业绩、排名、ETF / 二级交易 | `"000001.OF近1年业绩排名"` |
| `get_fund_holders` | 持有人结构、申赎、规模变动 | `"000001.OF持有人结构"` |
| `get_fund_company_info` | 基金管理公司档案、经理团队 | `"华夏基金管理公司档案"` |
